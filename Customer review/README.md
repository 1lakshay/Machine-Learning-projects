Deployed the most popular NLP technique known as the Bag of words model whose concept is to use the vector of vocabulary to find the sentiment of the inputs
